"""
Django settings for e_commerce_2 project.
...
SECRET_KEY = 'jc)r$s_-bxzk%5q#@)npc(4s_w79c7k7mpo&)+((qcm8t8m$a#'
...
ROOT_URLCONF = 'e_commerce_2.urls'
...
WSGI_APPLICATION = 'e_commerce_2.wsgi.application'
